...
def train(
    X_train: pd.DataFrame, y_train: pd.Series, preprocessor_rf: ColumnTransformer
    ...
    mlflow.sklearn.log_model(sk_model=pipeline_final, artifact_path=model_name, input_example=X_train.head(1))
