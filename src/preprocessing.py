...
def preprocessing(df:pd.DataFrame)-> tuple[pd.DataFrame, pd.DataFrame, pd.Series, pd.Series, ColumnTransformer]:
    ...
    df=df[df['TotalCharges'].str.contains("[^0-9.]")==False].copy()
